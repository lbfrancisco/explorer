...
let isOdd = sum % 2 ? "ímpar" : "par";
let isDifferent = firstNumber !== secondNumber ? "diferentes." : "iguais.";
...
alert(`A soma dos dois números é ${isOdd}: ${sum}`);
alert(`Os números inseridos são ${isDifferent}`);